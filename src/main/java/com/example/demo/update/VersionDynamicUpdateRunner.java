...
public class VersionDynamicUpdateRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        VersionDynamicUpdateObject v3 = versionDynamicUpdateStore.getOne(id);
        log.info("getById ==> {}", v3);
